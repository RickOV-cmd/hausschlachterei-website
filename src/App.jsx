...
export default function HausschlachtereiStrassberger() {
  ...
  return (
    <div className="website">
      ...
      {/* Render Sortiment Page */}
      {currentPage === 'sortiment' && (
        <>
          <header className={`header ${scrolled ? 'scrolled' : ''}`}>
            <div className="header-container">
              <div className="logo" onClick={() => navigateToPage('main')} style={{ cursor: 'pointer' }}>
          ...
          <div className="product-page">
            <div className="product-container">
              ...
              <div className="product-hero">
                <div className="product-hero-title">Unser Sortiment</div>
                <div className="product-hero-text">
                  Von der eigenen Schlachtung bis zum fertigen Produkt – alles aus einer Hand. 
                  Entdecken Sie unsere handgemachten Fleisch- und Wurstwaren aus regionaler Herkunft.
                </div>
              </div>

              {/* Frischfleisch */}
              <div className="category-section">
                <h2 className="category-title">Frischfleisch</h2>
                <p className="category-description">
                  Frisches Schweinefleisch aus eigener Schlachtung – von regionalen Höfen aus Schaumburg
                </p>

                <div className="product-grid">
                  <div className="product-card">
                    <div className="product-image">
                      📷 Produktbild: Schweinebraten
                    </div>
                    <div className="product-content">
                      <div className="product-category">Schweinefleisch</div>
                      <div className="product-name">Schweinebraten & Rollbraten</div>
                      <div className="product-description">
                        Saftige Braten aus der Schulter oder dem Nacken – perfekt für den Sonntagsbraten.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="product-card">
                    <div className="product-image">
                      📷 Produktbild: Koteletts
                    </div>
                    <div className="product-content">
                      <div className="product-category">Schweinefleisch</div>
                      <div className="product-name">Koteletts & Schnitzel</div>
                      <div className="product-description">
                        Zarte Koteletts und Schnitzel aus dem Rücken – ideal zum Braten oder Grillen.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="product-card">
                    ...
                    <div className="product-content">
                      <div className="product-category">Schweinefleisch</div>
                      <div className="product-name">Gulasch & Geschnetzeltes</div>
                      <div className="product-description">
                        Bestes Fleisch zum Schmoren – für herzhafte Eintöpfe und Gulasch.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="product-card">
                    <div className="product-image">
                      📷 Produktbild: Hackfleisch
                    </div>
                    <div className="product-content">
                      <div className="product-category">Schweinefleisch</div>
                      <div className="product-name">Hackfleisch</div>
                      <div className="product-description">
                        Frisch gewolftes Hackfleisch – für Frikadellen, Bolognese und vieles mehr.
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {/* Grillfleisch */}
              <div className="category-section">
                <h2 className="category-title">Grillfleisch</h2>
                <p className="category-description">
                  Saftige Grillspezialitäten – mariniert oder natur
                </p>

                <div className="product-grid">
                  <div className="product-card">
                    <div className="product-image">
                      📷 Produktbild: Nackensteaks
                    </div>
                    <div className="product-content">
                      <div className="product-category">Grillfleisch</div>
                      <div className="product-name">Nackensteaks</div>
                      <div className="product-description">
                        Saftige Nackensteaks – natur oder mariniert in verschiedenen Geschmacksrichtungen.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="product-card">
                    <div className="product-image">
                      📷 Produktbild: Grillspieße
                    </div>
                    <div className="product-content">
                      <div className="product-category">Grillfleisch</div>
                      <div className="product-name">Grillspieße</div>
                      <div className="product-description">
                        Leckere Fleischspieße – mit oder ohne Gemüse, perfekt für den Grill.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="product-card">
                    <div className="product-image">
                      📷 Produktbild: Bauchfleisch
                    </div>
                    <div className="product-content">
                      <div className="product-category">Grillfleisch</div>
                      <div className="product-name">Bauchfleisch</div>
                      <div className="product-description">
                        Saftiges Schweinebauchfleisch – knusprig vom Grill ein Genuss.
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {/* Wurstwaren */}
              <div className="category-section">
                <h2 className="category-title">Wurstwaren</h2>
                <p className="category-description">
                  Hausgemachte Wurstwaren nach traditioneller Rezeptur – mit natürlichen Gewürzen
                </p>

                <div className="product-grid">
                  <div className="product-card">
                    <div className="product-image">
                      📷 Produktbild: Bratwurst
                    </div>
                    <div className="product-content">
                      <div className="product-category">Wurst</div>
                      <div className="product-name">Bratwürste</div>
                      <div className="product-description">
                        Grobe und feine Bratwurst – perfekt für Pfanne und Grill. Auch als Thüringer oder Currywurst.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="product-card">
                    <div className="product-image">
                      📷 Produktbild: Leberwurst
                    </div>
                    <div className="product-content">
                      <div className="product-category">Wurst</div>
                      <div className="product-name">Leberwurst</div>
                      <div className="product-description">
                        Hausgemachte Leberwurst – fein oder grob, als Streichwurst oder zum Aufschneiden.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="product-card">
                    <div className="product-image">
                      📷 Produktbild: Blutwurst
                    </div>
                    <div className="product-content">
                      <div className="product-category">Wurst</div>
                      <div className="product-name">Blutwurst</div>
                      <div className="product-description">
                        Traditionelle Blutwurst – deftig und würzig, ideal zu Sauerkraut oder Kartoffelpüree.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="product-card">
                    <div className="product-image">
                      📷 Produktbild: Mettwurst
                    </div>
                    <div className="product-content">
                      <div className="product-category">Wurst</div>
                      <div className="product-name">Mettwurst & Schinkenwurst</div>
                      <div className="product-description">
                        Luftgetrocknete oder geräucherte Wurst – herzhaft im Geschmack, perfekt als Aufschnitt.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="product-card">
                    <div className="product-image">
                      📷 Produktbild: Bockwurst
                    </div>
                    <div className="product-content">
                      <div className="product-category">Wurst</div>
                      <div className="product-name">Bockwurst & Wiener</div>
                      <div className="product-description">
                        Klassische Würstchen zum Erwärmen – ideal für den schnellen Hunger.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="product-card">
                    ...
                    <div className="product-content">
                      <div className="product-category">Wurst</div>
                      <div className="product-name">Aufschnitt-Sortiment</div>
                      <div className="product-description">
                        Verschiedene Aufschnittsorten – von mild bis würzig, für jeden Geschmack.
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {/* Spezialitäten */}
              <div className="category-section">
                <h2 className="category-title">Spezialitäten & Hausgemachtes</h2>
                <p className="category-description">
                  Besondere Leckereien aus unserer Metzgerei
                </p>
                ...
                <div className="product-grid">
                  <div className="product-card">
                    ...
                    <div className="product-content">
                      <div className="product-category">Spezialitäten</div>
                      <div className="product-name">Sülze</div>
                      <div className="product-description">
                        Hausgemachte Sülze nach traditionellem Rezept – ein echter Klassiker.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="product-card">
                    ...
                    <div className="product-content">
                      <div className="product-category">Spezialitäten</div>
                      <div className="product-name">Griebenschmalz</div>
                      <div className="product-description">
                        Selbstgemachtes Schmalz mit knusprigen Grieben – perfekt aufs Brot.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="product-card">
                    ...
                    <div className="product-content">
                      <div className="product-category">Hausgemachtes</div>
                      <div className="product-name">Frische Salate</div>
                      <div className="product-description">
                        Kartoffelsalat, Nudelsalat, Krautsalat – täglich frisch zubereitet.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="product-card">
                    ...
                    <div className="product-content">
                      ...
                      <div className="product-name">Hausgemachte Suppen</div>
                      <div className="product-description">
                        Erbsensuppe, Gulaschsuppe, Hühnersuppe – nach Hausrezept.
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div style={{ 
                ...
                <p style={{ fontSize: '1.1rem', lineHeight: '1.7', marginBottom: '1.5rem', opacity: '0.95' }}>
                  Gerne nehmen wir auch Ihre Bestellungen entgegen – ob Aufschnittplatten für Ihre Feier, 
                  Wurstmollen oder andere Spezialwünsche. Sprechen Sie uns einfach auf den Wochenmärkten an!
                </p>
                <p style={{ 
                  fontSize: '0.95rem',
                  opacity: '0.9'
                }}>
                  📍 Besuchen Sie uns auf einem unserer Wochenmärkte
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="header-container">
          ...
          <nav className="nav-desktop">
            <ul className="nav-links">
              ...
              <li 
                className={`nav-link`}
                onClick={() => navigateToPage('sortiment')}
              >
                Sortiment
              </li>
              <li 
              ...
              <div className="modal-markets">
                ...
                <div className="modal-automat-card">
                  ...
                  <button 
                    className="btn btn-white"
                    onClick={() => {
                      openGoogleMaps('Neue Straße 2, Buchholz');
                      setShowMarketModal(false);
                    }}
                    style={{ width: '100%' }}
                  >
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <ul className="footer-links">
            ...
            <li className="footer-link" onClick={() => navigateToPage('sortiment')}>Sortiment</li>
